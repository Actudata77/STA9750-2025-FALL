...
![](images/blsjobs.png){width="100%" height="auto" fig-align="center"}
...
This claim appears frequently in commentary and media discussions. It implies that BLS initial
estimates are **systematically too low**, so revisions should usually be **positive**. With our
full CES dataset of total nonfarm payroll and revisions (1979–2025), we can test this directly.

#### Hypothesis Test

::: callout-note
**Question:** Is the *average* revision (final − original) strictly greater than zero?
...
- **t-statistic:** 3.26  
- **p-value:** 0.001 (formally “significant”)  
:::
...
interval crosses zero**, indicating that revisions vary widely from month to month. We do **not**
...
- **Fraction of positive revisions:** about **52.8%** — only slightly above 50%  
- **Largest upward revision:** **+345k** (pandemic shock; clearly not a routine bias)  
- **Largest downward revision:** **−537k** (also pandemic-related)  
...
::: callout-warning
**Bottom line:** The claim that *“BLS always underestimates job growth and then revises up”* is **not supported** by the data. Revisions are noisy, not consistently positive, and no decade shows a clear
systematic upward bias.
:::

::: callout-tip
**PolitiFact-style rating:** 🟧 **Mostly False**
:::
...
This is a **one-sided test** of whether volatility is higher in election years.
:::

#### Results (from Task 4.5)

::: callout-important
- **Mean absolute revision, election years:** \(\approx 55.2\text{k}\)  
- **Mean absolute revision, non-election years:** \(\approx 53.6\text{k}\)  
- **Difference (election − non-election):** \(\approx +1.6\text{k}\) (**very small**)  
- **95% bootstrap CI for difference:** \([ -18.5\text{k},\ +21.0\text{k} ]\)
:::
...
macroeconomic shocks such as recessions and the COVID-19 pandemic.
:::

::: callout-tip
**PolitiFact-style rating:** 🔴 **False**
:::
