...
```
The correlation between monthly CES employment change and the absolute size of CES revisions is negative and statistically significant (r = −0.143, p < 0.01).This indicates that months with larger employment changes tend to have slightly smaller revisions, though the relationship is weak in magnitude (|r| ≈ 0.14).
...
- **Difference (election − non-election):** +1.6k (very small)  
- **95% bootstrap CI for difference:** [−18.5k, +21.0k]
:::
...
Finally, applying these results to real political claims showed that popular narratives about CES bias or partisan influence are not supported by empirical evidence. While revisions are unavoidable in a large, complex survey like CES, they do not display long-term directional or political patterns.
