...
Cities scoring highest on this composite measure are successfully balancing affordability even when their population are increasing, while those scoring lowest face either restrictive zoning practices that suppresses building. This framework reveals that housing adequacy cannot be measured by raw permit counts alone; it requires understanding how permit issuance interact with housing growth and economics for each region.

### Visualization

The visualizations below examine the relationship between two housing affordability metrics: the **Rent Burden Index** and the **Housing Growth Score**. These plots identify metropolitan areas that exemplify “YIMBY” success: cities that addressed high housing costs by building more homes, improving affordability while at the same time maintaining or growing their populations.

**YIMBY success** is defined using four criteria:
...
3. **Population growth** — the metro area experienced population growth.
4. **Above-average housing growth** (score > 50) — the metro area built enough housing.
...
The first chart above spotlights the best-performing metros among the “perfect YIMBY” group—those that combined strong housing growth with improved affordability. In the plot below, we broaden the view to see how **all** metros perform across rent burden change and population growth.
...
The goal is to make housing attainable for working families while keeping job growth in essential industries like construction and health care.
:::

### 1. Congressional Sponsors

- **Primary Sponsor — Wilmington, NC Metro Area**  
  Wilmington exemplifies *YIMBY* success. Since 2009 it has permitted new housing at one of the fastest rates.  
  Median rents have stayed moderate, showing how flexible zoning  can restrain costs even following their   population and job growth.  
...
- **Co-Sponsor — New York–Newark–Jersey City, NY-NJ-PA Metro Area**  
  ...
  A federal incentive program would help such regions modernize zoning practices and accelerate building approvals.  
...
|-------------|----------------------------------------|
| **Construction and Skilled Trades** | Federal incentives for housing expansion directly boost demand for construction jobs. Wilmington’s data show that every 1 % increase in permitted units corresponds growth in construction employment. |
| **Health Care and Social Assistance (NAICS 62)** | High rent burdens disproportionately affect nurses, aides, and social-service staff. In metros such as New York, median rents consume over 40 % of household income. Lower rents would help sav more from their salaries and stabilize this essential workforce. |
...
*Estimates the share of income spent on rent — lower values mean affordability.*

Both indicators are easily derived from the **American Community Survey (ACS)**, enabling transparency.

---

### 4. Why This Matters

- **For Voters:** Affordable housing allows families to save more, spend, and stay in their communities.  
- **For Industries:** Stable housing costs sustain labor supply in key sectors like construction and healthcare.  
- **For Congress:** A bipartisan opportunity supporting economic growth, social equity, and does not require new spending.
...
By pairing a *YIMBY leader* (Wilmington, NC) with a *NIMBY reformer* (NY-NJ) and aligning the interests of construction and health-care workers, Congress can help lower rents, expands opportunities and keep America building.
:::
...
From a policy standpoint, these findings support the argument for a federal YIMBY initiative that rewards cities not only for expanding housing access but also for creating communities where affordability and opportunity can coexist.

Cities that embrace inclusive and effective planning will be better positioned to attract residents, especially the millennial as an example, and deliver on the promise of making backyards affordable for all.
